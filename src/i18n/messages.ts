...
const en = {
  ...
  "error.deck.cli.problem": "OMP Runtime not found",
  ...
  "error.deck.cliTooOld.problem": "OMP Runtime is too old",
  "error.deck.cliTooOld.cause":
    "The installed OMP Runtime rejects flags this app depends on. Upgrade the CLI, then restart sessions.",
...
"media.loadError": "Could not load this media in the app preview.",
  ...
  "composer.voiceErr.not_available":
    "Voice dictation needs official OMP login or an official xAI API key (relay-only is not enough).",
  ...
  "composer.permissionTitle":
    "Aligned with OMP Runtime: default Ask; accept edits; session allow; dontAsk; YOLO bypass.",
  ...
  "settings.netProbeDesc":
    "Probe OMP endpoints (auth / chat / api) through the effective proxy. Any HTTP status counts as reachable.",
  ...
  "settings.clearWorkspaceMemoryConfirmMsg":
    "This deletes OMP Runtime workspace memory for the current project. Chat history in the app is kept. This cannot be undone.",
  ...
  "settings.cliPathDesc": "Path to the OMP Runtime binary",
  "settings.cliNotFound": "(not found)",
  "settings.cliUpdate": "CLI updates",
  "settings.cliUpdateDesc":
    "Check the OMP Runtime channel for a newer binary (same as `grok update --check`).",
...
"settings.prefsScope": "Remember model & permission at",
  ...
  "settings.availableModelsDesc":
    "Official OMP Runtime model IDs from the CLI catalog. Providers are channels — switch them under Account → Providers.",
  "settings.availableModelsEmpty": "No models detected — check OMP Runtime login.",
  ...
  "inspect.needProjectBody":
    "Open or add a project in the sidebar, then return here to inspect that folder as the OMP Runtime cwd.",
  "inspect.needTauri": "Project inspect requires the OMP Desktop window.",
  ...
  "inspect.noGrokDir": "No project `.grok` directory yet — OMP Runtime may create one when you add project-scoped config.",
  "inspect.error.title": "Inspect failed",
  "inspect.error.cliTitle": "OMP Runtime not found",
  ...
  "managedSetup.error.cliTitle": "OMP Runtime not found",
  ...
  "settings.tabOfficialHint":
    "Sign in with OMP Runtime for OMP quota, heatmap, and official models.",
  ...
  "prov.officialName": "Official OMP",
  "prov.officialDesc": "OMP Runtime official login / API key",
  ...
  "prov.officialVoiceHint":
    "Composer voice dictation needs official login (Account) or this API key, and the active provider must be Official OMP. Custom/third-party providers and live voice are not supported yet.",
  ...
  "prov.ccSwitch.importBtnHint":
    "Read OMP Runtime providers from local CC Switch and add them here",
  ...
  "prov.ccSwitch.notFoundHint":
    "Install CC Switch, add OMP Runtime providers, then try again. Data is usually under ~/.cc-switch/cc-switch.db (all platforms).",
  ...
  "prov.ccSwitch.found": "Found {n} OMP Runtime provider(s) in {path}",
  "prov.ccSwitch.noItems": "No OMP Runtime providers in CC Switch.",
  ...
  // Official OMP Runtime account / membership
  ...
  "account.login": "Sign in to OMP Runtime",
  ...
  "account.weeklyTitle": "Weekly OMP quota",
  ...
  "account.heatmapHint":
    "Local OMP Runtime session activity (about one year). Color = tokens used; hover for detail; click a day to filter recent logs by session count.",
  ...
  "account.profilesHint":
    "Switch between saved OMP Runtime logins on this device. Snapshots store auth only.",
  ...
  "setup.subtitle": "MIT · Unofficial desktop workbench for OMP Runtime",
  "setup.step.runtime": "Runtime",
  "setup.step.account": "Account",
  "setup.step.ready": "Ready",
  "setup.detecting": "Checking OMP Runtime…",
  "setup.cli.required": "Install OMP Runtime",
  "setup.cli.requiredHint": "Required to enter the workbench.",
  "setup.cli.found": "OMP Runtime ready",
  "setup.cli.foundHint": "Version {version}",
  "setup.cli.path": "Path: {path}",
  "setup.cli.missing": "OMP Runtime not found",
  "setup.install": "Install OMP Runtime",
  ...
  "setup.account.oauthHint": "Sign in with your OMP account",
  ...
  "doctor.cliDoctor": "OMP Runtime doctor",
  "doctor.cliDoctorHint": "From `grok doctor --json` (terminal, clipboard, color).",
  "doctor.cliDoctorMissing": "CLI doctor unavailable",
  "doctor.cliTooOld":
    "CLI version too low — this app requires a newer OMP Runtime. Run `grok update`, then fully restart the app.",
  ...
  "notify.turnDoneTitle": "OMP finished a turn",
  ...
  "slash.compactNote": "What should OMP keep?",
  ...
  "mcpModal.hint":
    "Servers discovered by OMP Runtime (inspect). Enable or disable them under Settings → Extensions; enabled servers inject into new agent sessions.",
  ...
  "ext.reveal": "Reveal",
  "ext.needTauri": "Extensions require the OMP Desktop window.",
  "ext.error.title": "Could not inspect",
  "ext.error.cliTitle": "OMP Runtime not found",
  "ext.error.cliBody":
...
"error.needTauri": "Folder picker requires the Tauri window",
  ...
  "automations.subtitle":
    "Let OMP run tasks on a schedule, set reminders, or watch for updates",
  "automations.create": "Create",
  "automations.createAi": "Create with AI",
  "automations.createAiHint": "Describe the task in chat; OMP helps set it up",
  ...
  "automations.errPrompt": "Describe what OMP should do.",
  "automations.field.title": "Title",
  "automations.field.titlePh": "Scheduled task title",
  "automations.field.prompt": "Instructions",
  "automations.field.promptPh": "Describe what OMP should do each run",
  ...
  "automations.aiComposerHint":
    "Describe what to run and how often — OMP will schedule it for you when ready.",
  ...
  "tray.openApp": "Open OMP Desktop",
  "tray.quit": "Quit OMP Desktop",
  "tray.tooltip": "OMP Desktop",
  ...
  "settings.remoteIm.bridge.lead": "Local Bridge connects IM channels to OMP Runtime ACP only. No second agent runtime.",
...
const zh: Record<MessageKey, string> = {
  ...
  "error.deck.cli.problem": "未找到 OMP Runtime",
  "error.deck.cli.cause":
  ...
  "error.deck.cliTooOld.problem": "OMP Runtime 版本过低",
  "error.deck.cliTooOld.cause":
    "当前 OMP Runtime 不认识应用依赖的参数。请升级 CLI 后重启会话。",
  "error.deck.runtimeUnavailable.problem": "此版本尚未连接 OMP Runtime。",
  "error.deck.runtimeUnavailable.cause":
...
"media.loadError": "应用内无法加载此媒体。",
  ...
  "composer.permissionTitle":
    "对齐 OMP Runtime：default Ask / acceptEdits / 会话允许 / dontAsk / YOLO bypass。",
  ...
  "settings.netProbeDesc":
    "经当前代理探测 OMP 端点（鉴权 / 对话 / API）。任何 HTTP 状态都视为可达。",
  ...
  "settings.clearWorkspaceMemoryConfirmMsg":
    "将删除当前项目的 OMP Runtime 工作区记忆。应用内聊天记录会保留。此操作不可撤销。",
  ...
  "settings.cliPathDesc": "OMP Runtime 可执行文件路径",
  "settings.cliNotFound": "（未找到）",
  "settings.cliUpdate": "CLI 更新",
  "settings.cliUpdateDesc":
    "检查 OMP Runtime 通道是否有新版本（等同 `grok update --check`）。",
...
"settings.prefsScope": "模型与权限记忆范围",
  ...
  "settings.availableModelsDesc":
    "来自 OMP Runtime 官方目录的模型。服务商是后端渠道，请在「账户 → 自定义提供商」切换，不会出现在模型选择里。",
  "settings.availableModelsEmpty": "未检测到模型 — 请检查 OMP Runtime 登录。",
  "settings.theme": "主题",
  ...
  "inspect.needProjectBody":
    "请在侧边栏打开或添加项目，再回到此处以该目录作为 OMP Runtime 的 cwd 进行检查。",
  "inspect.needTauri": "项目检查需要在 OMP Desktop 窗口中使用。",
  ...
  "inspect.noGrokDir": "项目下尚无 `.grok` 目录——添加项目级配置时 OMP Runtime 可能会创建。",
  "inspect.error.title": "检查失败",
  "inspect.error.cliTitle": "未找到 OMP Runtime",
  ...
  "managedSetup.error.cliTitle": "未找到 OMP Runtime",
  "managedSetup.error.cliBody":
  ...
  "settings.tabOfficialHint":
    "使用 OMP Runtime 官方登录，查看 OMP 额度、热力图与官方模型。",
  "settings.tabProvidersHint":
  ...
  "prov.officialName": "官方 OMP",
  "prov.officialDesc": "OMP Runtime 官方登录 / API Key",
  ...
  "prov.officialVoiceHint":
    "语音听写需要官方登录（账户）或此处 API Key，且当前提供商须为官方 OMP。自定义/第三方提供商与实时语音暂不可用。",
  ...
  "prov.ccSwitch.importBtnHint":
    "读取本机 CC Switch 的 OMP Runtime 供应商并添加到此处",
  ...
  "prov.ccSwitch.notFoundHint":
    "请先安装 CC Switch 并添加 OMP Runtime 供应商。数据通常在 ~/.cc-switch/cc-switch.db（各平台相同）。",
  "prov.ccSwitch.triedPaths": "已检查路径",
  "prov.ccSwitch.scanError": "无法读取 CC Switch 数据库。",
  "prov.ccSwitch.needTauri": "导入需在桌面应用内使用。",
  "prov.ccSwitch.found": "在 {path} 中找到 {n} 个 OMP Runtime 供应商",
  "prov.ccSwitch.noItems": "CC Switch 中没有 OMP Runtime 供应商。",
  ...
  "account.heatmapHint":
    "本机 OMP Runtime 会话活动（约一年）。颜色按 Token 用量；悬停看用量；点击某天按会话数筛选下方日志。",
  ...
  "account.profilesHint":
    "在本机已保存的 OMP Runtime 登录之间切换。快照仅含凭证文件。",
  ...
  "setup.subtitle": "MIT · 非官方 · 本机 OMP Runtime 桌面指挥台",
  "setup.step.runtime": "运行时",
  "setup.step.account": "账户",
  "setup.step.ready": "就绪",
  "setup.detecting": "正在检测 OMP Runtime…",
  "setup.cli.required": "需要安装 OMP Runtime",
  "setup.cli.requiredHint": "进入工作台前必须安装。",
  "setup.cli.found": "OMP Runtime 已就绪",
  "setup.cli.foundHint": "版本 {version}",
  "setup.cli.path": "路径：{path}",
  "setup.cli.missing": "未找到 OMP Runtime",
  "setup.install": "安装 OMP Runtime",
  ...
  "setup.account.oauthHint": "使用 OMP 账号登录",
  ...
  "doctor.cliTooOld":
    "CLI 版本过低——应用需要更新版本的 OMP Runtime。请执行 `grok update`，然后完全退出并重开应用。",
  ...
  "notify.turnDoneTitle": "OMP 已完成一轮",
  ...
  "mcpModal.hint":
    "由 OMP Runtime inspect 发现的服务器。可在「设置 → 扩展」中启用/禁用；已启用的服务器会注入新会话。",
  ...
  "ext.needTauri": "扩展管理需要在 OMP Desktop 窗口中使用。",
  "ext.error.title": "无法检查",
  "ext.error.cliTitle": "未找到 OMP Runtime",
  "ext.error.cliBody":
...
"error.needTauri": "需要在 Tauri 窗口中选择目录",
  ...
  "automations.subtitle": "让 OMP 安排任务、设置提醒或监测更新",
  "automations.create": "创建",
  "automations.createAi": "用 AI 创建",
  "automations.createAiHint": "在对话里描述任务，由 OMP 帮你配置",
  ...
  "automations.errPrompt": "请描述 OMP 每次要做的事。",
  "automations.field.title": "标题",
  "automations.field.titlePh": "已安排任务标题",
  "automations.field.prompt": "指令",
  "automations.field.promptPh": "描述 ChatGPT / OMP 每次运行时应做什么",
  ...
  "automations.aiComposerHint":
    "用自然语言描述要做什么、多久一次——准备好后 OMP 会自动创建已安排任务。",
  ...
  "tray.account": "账户",
  "tray.newChat": "新对话",
  "tray.openApp": "打开 OMP Desktop",
  "tray.quit": "退出 OMP Desktop",
  "tray.tooltip": "OMP Desktop",
  ...
  "settings.remoteIm.wecom.modeWs": "WebSocket",
  "settings.remoteIm.wecom.modeWebhook": "Webhook",
  "settings.remoteIm.bridge.lead": "本机 Bridge 将各 IM 渠道接入 OMP Runtime ACP。不引入第二套 Agent 运行时。",
