...
export const zhTW: Record<MessageKey, string> = {
  ...
  "app.versionFooter": "OMP v0.3.1-nightly · MIT · 非 xAI 官方 · 姊妹專案 grok-go",
  ...
  "error.deck.cli.problem": "找不到 OMP Runtime",
  ...
  "error.deck.cliTooOld.problem": "OMP Runtime 版本過舊",
  "error.deck.cliTooOld.cause":
    "目前的 OMP Runtime 不認得應用相依的參數。請升級 CLI 後重新啟動對話。",
  "error.deck.runtimeUnavailable.problem": "此版本尚未連接 OMP Runtime。",
...
"media.loadError": "應用程式內無法載入此媒體。",
  ...
  "composer.permissionTitle":
    "對齊 OMP Runtime：default Ask / acceptEdits / 對話允許 / dontAsk / YOLO bypass。",
  ...
  "settings.netProbeDesc":
    "經目前代理探測 OMP 端點（驗證 / 對話 / API）。任何 HTTP 狀態都視為可達。",
  ...
  "settings.clearWorkspaceMemoryConfirmMsg":
    "將刪除目前專案的 OMP Runtime 工作區記憶。應用程式內聊天紀錄會保留。此操作無法復原。",
  ...
  "settings.cliPathDesc": "OMP Runtime 可執行檔路徑",
  "settings.cliNotFound": "（未找到）",
  "settings.cliUpdate": "CLI 更新",
  "settings.cliUpdateDesc":
    "檢查 OMP Runtime 通道是否有新版本（等同 `grok update --check`）。",
...
"settings.prefsScope": "模型與權限記憶範圍",
  ...
  "settings.availableModelsDesc":
    "來自 OMP Runtime 官方目錄的模型。服務商是後端通道，請在「帳戶 → 自訂供應商」切換，不會出現在模型選擇裡。",
  "settings.availableModelsEmpty": "未偵測到模型 — 請檢查 OMP Runtime 登入。",
  "settings.theme": "主題",
  ...
  "inspect.needProjectBody":
    "請在側邊欄開啟或新增專案，再回到此處以該目錄作為 OMP Runtime 的 cwd 進行檢查。",
  "inspect.needTauri": "專案檢查需要在 OMP Desktop 視窗中使用。",
  ...
  "inspect.noGrokDir": "專案下尚無 `.grok` 目錄——新增專案級設定時 OMP Runtime 可能會建立。",
  "inspect.error.title": "檢查失敗",
  "inspect.error.cliTitle": "找不到 OMP Runtime",
  ...
  "managedSetup.error.cliTitle": "找不到 OMP Runtime",
  ...
  "settings.tabOfficialHint":
    "使用 OMP Runtime 官方登入，檢視 OMP 額度、熱力圖與官方模型。",
  ...
  "prov.officialDesc": "OMP Runtime 官方登入 / API Key",
  ...
  "prov.officialVoiceHint":
    "語音聽寫需要官方登入（帳戶）或此處 API Key，且目前供應商須為官方 OMP。自訂/第三方供應商與即時語音暫不可用。",
  ...
  "prov.ccSwitch.importBtnHint":
    "讀取本機 CC Switch 的 OMP Runtime 供應商並新增到此處",
  ...
  "prov.ccSwitch.notFoundHint":
    "請先安裝 CC Switch 並新增 OMP Runtime 供應商。資料通常在 ~/.cc-switch/cc-switch.db（各平台相同）。",
  "prov.ccSwitch.triedPaths": "已檢查路徑",
  "prov.ccSwitch.scanError": "無法讀取 CC Switch 資料庫。",
  "prov.ccSwitch.needTauri": "匯入需在桌面應用內使用。",
  "prov.ccSwitch.found": "在 {path} 中找到 {n} 個 OMP Runtime 供應商",
  "prov.ccSwitch.noItems": "CC Switch 中沒有 OMP Runtime 供應商。",
  ...
  "account.heatmapHint":
    "本機 OMP Runtime 對話活動（約一年）。顏色依 Token 用量；懸停看用量；點某天依對話數篩選下方日誌。",
  ...
  "account.profilesHint":
    "在本機已儲存的 OMP Runtime 登入之間切換。快照僅含憑證檔案。",
  ...
  "setup.subtitle": "MIT · 非官方 · 本機 OMP Runtime 桌面控制台",
  "setup.step.runtime": "執行環境",
  "setup.step.account": "帳戶",
  "setup.step.ready": "就緒",
  "setup.detecting": "正在偵測 OMP Runtime…",
  "setup.cli.required": "需要安裝 OMP Runtime",
  "setup.cli.requiredHint": "進入工作台前必須安裝。",
  "setup.cli.found": "OMP Runtime 已就緒",
  "setup.cli.foundHint": "版本 {version}",
  "setup.cli.path": "路徑：{path}",
  "setup.cli.missing": "未找到 OMP Runtime",
  "setup.install": "安裝 OMP Runtime",
  ...
  "setup.account.oauthHint": "使用 OMP 帳號登入",
  ...
  "doctor.cliTooOld":
    "CLI 版本過舊——應用需要較新版本的 OMP Runtime。請執行 `grok update`，然後完全結束並重開應用程式。",
  ...
  "notify.turnDoneTitle": "OMP 已完成一輪",
  ...
  "mcpModal.hint":
    "由 OMP Runtime inspect 發現的伺服器。可在「設定 → 擴充」中啟用/停用；已啟用的伺服器會注入新對話。",
  ...
  "ext.reveal": "在檔案總管中顯示",
  "ext.needTauri": "擴充管理需要在 OMP Desktop 視窗中使用。",
  "ext.error.title": "無法檢查",
  "ext.error.cliTitle": "找不到 OMP Runtime",
  "ext.error.cliBody":
...
"error.needTauri": "需要在 Tauri 視窗中選擇目錄",
  ...
  "automations.subtitle": "讓 OMP 排程任務、設定提醒或監測更新",
  "automations.create": "建立",
  "automations.createAi": "用 AI 建立",
  "automations.createAiHint": "在對話裡描述任務，由 OMP 幫你設定",
  ...
  "automations.errPrompt": "請描述 OMP 每次要做的事。",
  "automations.field.title": "標題",
  "automations.field.titlePh": "已排程任務標題",
  "automations.field.prompt": "指令",
  "automations.field.promptPh": "描述 ChatGPT / OMP 每次執行時應做什麼",
  ...
  "automations.aiComposerHint":
    "用自然語言描述要做什麼、多久一次——準備好後 OMP 會自動建立已排程任務。",
  ...
  "tray.account": "帳戶",
  "tray.newChat": "新對話",
  "tray.openApp": "開啟 OMP Desktop",
  "tray.quit": "結束 OMP Desktop",
